...
The generated files will be placed in the output directory (default: `_site`). You can then host this directory with any static file server or hosting service.
