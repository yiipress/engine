...
- **`SyntaxHighlighterBench`** — measures the reusable highlighter package path for plain HTML, a single highlighted block, and a page with many highlighted blocks
