...
- **Lifecycle hooks** expose PSR-14 build and render events for plugin behavior that is not a single content transformation. See [Plugins](plugins.md#lifecycle-hooks).
