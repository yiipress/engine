...
- **Parallel builds** — auto-selects a sensible worker count by default, with manual override available; 10 000 entries built in ~0.55 s in the current end-to-end benchmark
