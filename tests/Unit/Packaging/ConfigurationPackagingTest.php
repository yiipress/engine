...
final class ConfigurationPackagingTest extends TestCase
{
    ...
    public function runTestsWorkflowCoversLinuxAndWindows(): void
    {
        ...
        self::assertStringNotContainsString('--ignore-platform-req=ext-mdparser', $workflow);
        self::assertStringNotContainsString('--ignore-platform-req=ext-highlighter', $workflow);
